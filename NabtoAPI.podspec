...
DESC
  ...
  s.license      =   { :type => "Commercial", :file => "nabto-libs-ios-static/LICENSE.txt" }
  s.author       = { "Nabto" => "apps@nabto.com" }

  s.source           = { :http => "https://downloads.nabto.com/assets/nabto-ios-client-static/4.3.0-beta.3/nabto-libs-ios-static.zip" }
